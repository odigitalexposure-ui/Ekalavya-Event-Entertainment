  ...
  return (
    <main className="overflow-hidden bg-white">
      ...
      <section className="bg-white py-6 sm:py-8 lg:py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="rounded-none bg-[#650a34] px-4 py-10 text-center shadow-2xl shadow-[#650a34]/20 sm:px-6 lg:py-16">
            ...
            <Link
              to="/contact"
              className="mt-6 inline-flex items-center gap-2 rounded-none bg-white px-5 py-3 text-xs font-bold uppercase tracking-[0.08em] text-[#650a34] shadow-lg shadow-black/10 transition hover:-translate-y-1 hover:bg-[#ed1968] hover:text-white sm:px-8 sm:py-4 sm:text-sm sm:tracking-wide"
            >
              Enquire Now
              <ArrowRight size={18} />
            </Link>
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-950/85 p-4 backdrop-blur-md">
          ...
          <button
            onClick={prevItem}
            className="absolute left-5 top-1/2 z-10 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-none bg-white text-[#650a34] md:flex"
          >
            <ArrowLeft size={22} />
          </button>
          ...
          <button
            onClick={nextItem}
            className="absolute right-5 top-1/2 z-10 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-none bg-white text-[#650a34] md:flex"
          >
            <ArrowRight size={22} />
          </button>
